...
public class ApiController : MonoBehaviour
{
    ...
    private void InitDictionary()
    {
        ...
        Global.RegisterItem("Screen", GameObject.Find("Main Camera").transform.GetChild(0).gameObject);
        Global.RegisterItem("CloseBtn", GameObject.Find("Main Camera").transform.GetChild(0).transform.GetChild(0).Find("CloseBtn").gameObject);
        ...
        Global.setFlag("Screen", 0);
        Global.setFlag("CloseBtn", 1);
        Global.setFlag("globalInstance", 0);
        Global.setFlag("isShown", 1);
    }
